...
for delta in deltas: 
    try :   
        ...
        """coils = [
                ...
                ("E1", Coil(0.505000, -0.700000)), #https://drive.google.com/file/d/1SOr3yDZZTjZ5mmAGGIBmAdx50DB7dxsl/view?usp=drive_link
                ...
                ("T1", Coil(1.554000, -0.780000)), #estimated turns, no info available
                ...
                (
                    ...
                    Circuit(
                        [
                            ("B1", Coil(0.445700,-0.936000), 1.0),
                            ("B2", Coil(0.445700,0.936000), 1.0)
                        ]
                    ),
                ),
                (
        ...
        fname = "TCV_equilibria/tcv_delta{:1.3f}".format(delta).replace(".","pt")
        ...
        with open(fname + ".geqdsk", "w") as f:
            geqdsk.write(eq, f)
    except : 
        print("Failed, skipping delta={:1.3f}".format(delta))